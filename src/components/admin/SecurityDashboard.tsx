...
const SecurityDashboard: React.FC<SecurityDashboardProps> = ({ currentAdminId }) => {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-primary-foreground font-medium">{securityPolicy.passwordPolicy.minLength} chars</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-primary-foreground font-medium">{securityPolicy.passwordPolicy.expirationDays} days</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-primary-foreground font-medium">{securityPolicy.sessionSettings.timeoutHours}h</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-primary-foreground font-medium">{securityPolicy.sessionSettings.rememberLoginDays} days</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Quick Actions */}
      <div className="bg-black rounded-xl shadow-sm border border-gray-800 p-6">
        <h3 className="text-lg font-semibold text-primary-foreground mb-6">Quick Security Actions</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <button className="flex items-center space-x-3 p-4 border border-gray-700 rounded-lg hover:bg-gray-900 transition-colors text-left">
            ...
            <div>
              <div className="font-medium text-primary-foreground">Change Password</div>
          ...
          <button className="flex items-center space-x-3 p-4 border border-gray-700 rounded-lg hover:bg-gray-900 transition-colors text-left">
            <Shield size={20} className="text-green-600" />
            <div>
              <div className="font-medium text-primary-foreground">Review Sessions</div>
              <div className="text-sm text-muted-foreground">Check active logins</div>
            </div>
          </button>
          ...
          <button className="flex items-center space-x-3 p-4 border border-gray-700 rounded-lg hover:bg-gray-900 transition-colors text-left">
            ...
            <div>
              <div className="font-medium text-primary-foreground">Audit Logs</div>
              <div className="text-sm text-muted-foreground">View recent activity</div>
            </div>
          </button>
          ...
          <button className="flex items-center space-x-3 p-4 border border-gray-700 rounded-lg hover:bg-gray-900 transition-colors text-left">
            ...
            <div>
              <div className="font-medium text-primary-foreground">Security Scan</div>
              <div className="text-sm text-muted-foreground">Check for issues</div>
            </div>
          </button>
        </div>
      </div>
