    ...
    <AdminPageWrapper pageName="Blog Editor Dashboard" pageTitle="Blog Editor">
      <div className="min-h-screen bg-background pt-20">
        <div className="editorial-grid py-8">
          ...
          {/* Communications Hub - Prominent Section for Blog Editors */}
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                  {blogStats.unreadMessages > 0 && (
                    <div className="text-center">
                      <div className="text-3xl font-bold text-gdg-blue">{blogStats.unreadMessages}</div>
                      <div className="text-sm text-muted-foreground">Unread Messages</div>
                    </div>
                  )}
                  {blogStats.pendingTasks > 0 && (
                    <div className="text-center">
                      <div className="text-3xl font-bold text-gdg-yellow">{blogStats.pendingTasks}</div>
                      <div className="text-sm text-muted-foreground">Pending Tasks</div>
                    </div>
                  )}
                  {blogStats.unreadAnnouncements > 0 && (
                    <div className="text-center">
                      <div className="text-3xl font-bold text-gdg-red">{blogStats.unreadAnnouncements}</div>
                      <div className="text-sm text-muted-foreground">New Announcements</div>
                    </div>
                  )}
                  {blogStats.unreadMessages === 0 && blogStats.pendingTasks === 0 && blogStats.unreadAnnouncements === 0 && (
