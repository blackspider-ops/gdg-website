    ...
    <div className="min-h-screen bg-background pt-20">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">Linktree Pages</h1>
                <p className="text-muted-foreground mt-1">Create and manage custom link pages for your organization</p>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <Card className="lg:col-span-1">
          <CardHeader>
            <CardTitle>Link Pages</CardTitle>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <CardDescription>
                          ...
                          >
                            View live page: {getLinktreeUrl(selectedProfile.username)}
                  ...
                  <CardContent>
                    ...
                    {links.length === 0 && (
                      <div className="text-center py-8">
                        <p className="text-muted-foreground">No links added yet. Start building your link page!</p>
                        <Button 
                          variant="outline" 
                          className="mt-2"
                  ...
                  <CardHeader>
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <CardDescription>Customize your link page appearance and details</CardDescription>
                      </div>
            ...
            <Card>
              <CardContent className="flex items-center justify-center h-64">
                <div className="text-center">
                  <p className="text-muted-foreground mb-4">No link pages created yet</p>
                  <Button onClick={() => setShowProfileForm(true)}>
                    <Plus className="w-4 h-4 mr-2" />
