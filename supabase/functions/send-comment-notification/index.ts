          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="action-buttons">
                <a href="${Deno.env.get('SITE_URL') || 'https://gdgpsu.dev'}/admin/blog?tab=comments" class="btn btn-primary">
                  Review Comments
                </a>
                <a href="${Deno.env.get('SITE_URL') || 'https://gdgpsu.dev'}/blog/${blog_post_slug}" class="btn btn-secondary">
                  View Blog Post
                </a>
              </div>
            ...
            <div class="footer">
              ...
              <p>
                <a href="${Deno.env.get('SITE_URL') || 'https://gdgpsu.dev'}/admin">Admin Dashboard</a> | 
                <a href="${Deno.env.get('SITE_URL') || 'https://gdgpsu.dev'}">GDG@PSU Website</a>
              </p>
...
${Deno.env.get('SITE_URL') || 'https://gdgpsu.dev'}/admin/blog?tab=comments

View the blog post:
${Deno.env.get('SITE_URL') || 'https://gdgpsu.dev'}/blog/${blog_post_slug}
...
GDG@PSU - Google Developer Group at Penn State University
    ...
    const emailPayload = {
      from: 'GDG@PSU Blog <contact@gdgpsu.dev>',
      to: recipients,
      subject: subject,
      html: htmlContent,
      text: textContent,
